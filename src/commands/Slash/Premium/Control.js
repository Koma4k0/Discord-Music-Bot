        ...
        if (choice === "display") {
            if (!Control) {
                ...
                Control.save()
                    .then(() => {
                        const embed = new EmbedBuilder()
                            .setDescription(`<:onn:1202601941436469289> | Control has been set to: \`Enable\``)
                ...
                Control.save()
                    .then(() => {
                        const embed = new EmbedBuilder()
                            .setDescription(`<:onn:1202601941436469289> | Control has been changed to: \`Enable\``)
                            .setColor(client.color);
            ...
            if (!Control) {
                ...
                Control.save()
                    .then(() => {
                        const embed = new EmbedBuilder()
                            .setDescription(`<:off:1202601862881087509> | Control has been set to: \`Disable\``)
                            .setColor(client.color);
                ...
                Control.save()
                    .then(() => {
                        const embed = new EmbedBuilder()
                            .setDescription(`<:off:1202601862881087509> | Control has been changed to: \`Disable\``)
                            .setColor(client.color);
