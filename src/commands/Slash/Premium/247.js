...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (data) {
            ...
            const off = new EmbedBuilder().setDescription(`<:off:1202601862881087509> | 247 Mode has been: \`Disabled\``).setColor(client.color);
            ...
            const on = new EmbedBuilder().setDescription(`<:onn:1202601941436469289> | 247 Mode has been: \`Enabled\``).setColor(client.color);
