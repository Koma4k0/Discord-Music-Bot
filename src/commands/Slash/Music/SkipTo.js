...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (value > player.queue.length) {
            const embed = new EmbedBuilder().setDescription(`\<:icon_cross:1201253258749030440>\ | Song position was: \`Not found\``).setColor(client.color);
        ...
        if (value === 1) {
            ...
            const embed = new EmbedBuilder().setColor(client.color).setDescription(`\<:skip:1201252549974573208>\ | Song skipped to position: \`${value}\``);
