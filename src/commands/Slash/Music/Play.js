...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (loadType === "PLAYLIST_LOADED") {
            ...
            const embed = new EmbedBuilder()
                .setColor(client.color)
                .setDescription(`\<:Check:1201254751833178213>\ | **[${playlistInfo.name}](${song})** • \`${tracks.length}\` tracks • ${track.info.requester}`);
            ...
            const embed = new EmbedBuilder()
                .setColor(client.color)
                .setDescription(
                    `\<:Check:1201254751833178213>\ | **[${track.info.title ? track.info.title : "Unknown"}](${track.info.uri})** • \`${
            ...
            const embed = new EmbedBuilder().setColor(client.color).setDescription(`\<:icon_cross:1201253258749030440>\ | Song was no found or Failed to load song!`);
