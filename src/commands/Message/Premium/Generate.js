...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!plan) return message.reply({ content: `\<:icon_cross:1201253258749030440>\ | You didn't provide any type of plans: \`${plans.join(", ")}\`` });

        if (!plans.includes(plan))
            return message.reply({ content: `\<:icon_cross:1201253258749030440>\ | You didn't provide any valid type of plans: \`${plans.join(", ")}\`` });
