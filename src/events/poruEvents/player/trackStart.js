...
module.exports.run = async (client, player, track) => {
    ...
    const filter = (message) => {
        if (message.guild.members.me.voice.channel && message.guild.members.me.voice.channelId === message.member.voice.channelId)
            ...
            message.reply({
                content: `\<:icon_cross:1201253258749030440>\ | You must be on the same voice channel as mine to use this button.`,
                ephemeral: true,
            });
        }
    };
    ...
    collector.on("collect", async (message) => {
        if (message.customId === "loop") {
            ...
            if (!player) {
                ...
                const embed = new EmbedBuilder().setColor(client.color).setDescription(`\<:icon_cross:1201253258749030440>\ | Song can't be replay`);
            ...
            if (!player) {
                ...
                const embed = new EmbedBuilder().setDescription(`\<:icon_cross:1201253258749030440>\ | Queue is: \`Empty\``).setColor(client.color);
            ...
            if (!player) {
                ...
                const embed = new EmbedBuilder().setDescription(`\<:icon_cross:1201253258749030440>\ | Previous song was: \`Not found\``).setColor(client.color);
            ...
            if (!player) {
                ...
                const embed = new EmbedBuilder().setDescription(`\<:icon_cross:1201253258749030440>\ | Volume can't be lower than: \`10%\``).setColor(client.color);
            ...
            if (!player) {
                ...
                const embed = new EmbedBuilder().setDescription(`\<:icon_cross:1201253258749030440>\ | Volume can't be higher than: \`100%\``).setColor(client.color);
